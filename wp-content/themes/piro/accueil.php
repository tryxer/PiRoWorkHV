...
?>
    ...
    <section id="aPropos" class="scrollspy container">
        <div class="section">
            ...
            <div class="row">
                <div class="fixeImageApropos col l6">
                ...
                <div class="col l6">
                    ...
                    <div class="col l12">
                        <blockquote class="flow-text oblique blue-text right"><p>Source : Wikipedia - Biographie d'Hervé Vilard</p>
                        </blockquote>
                    </div>
                </div>
                <a href="apropos.html">
    ...
    <section id="contact" class="scrollspy container">
        <div class="section">
            <div class="divider"></div>
            <h2 class="flow-text white-text">Votre avis m'intéresse...</h2>
        </div>
    </section>
    <div class="parallax-container">
        <div class="container fixeImageParallax parallax">
            <img class="responsive-img" src="wp-content/uploads/2017/09/IMG_9851-2.png">
        </div>
    </div>
